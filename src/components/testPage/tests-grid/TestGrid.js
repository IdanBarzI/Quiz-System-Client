...
const TestGrid = () => {
      ...
      return(
        <Fragment key={idx}>
          <TableRow key={test._id} className={classes.row}>
              ...
              <TableCell>
                <button onClick={()=>handleCopyLinkToClipBoard(test.testUrl)}>Copy Link</button>
              </TableCell>
  ...
  return (
    <div className={classes.container}>
      ...
      <Pagination itemsPerPage={testsPerPage} totalItems={tests.length} currentPage={currentPage} paginate={paginate}/>
      {!isAllShown?
